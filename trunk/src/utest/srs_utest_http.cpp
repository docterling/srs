...
VOID TEST(ProtocolHTTPTest, ClientRequest)
{
    ...
    if (true) {
        MockBufferIO io;
        io.append(mock_http_response2(200, "6\r\nHello!\r\n0\r\n\r\n"));
        SrsHttpParser hp;
        HELPER_ASSERT_SUCCESS(hp.initialize(HTTP_RESPONSE));
        ISrsHttpMessage *msg = NULL;
        HELPER_ASSERT_SUCCESS(hp.parse_message(&io, &msg));
...
VOID TEST(ProtocolHTTPTest, ParsingLargeMessages)
{
    ...
    if (true) {
        ...
        string body;
        HELPER_ASSERT_SUCCESS(msg->body_read_all(body));
    ...
    if (true) {
        ...
        r.in_bytes.push_back(string((char *)p, 4096));
        p += 4096;
        r.in_bytes.push_back(string((char *)p, 165 + 6317 - 4096));
        p += 165 + 6317 - 4096;
        ISrsHttpMessage *msg = NULL;
        HELPER_ASSERT_SUCCESS(hp.parse_message(&r, &msg));
        SrsUniquePtr<ISrsHttpMessage> msg_uptr(msg);
